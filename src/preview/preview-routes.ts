...
export const previewRoutes: PreviewRoute[] = [
  ...
  { href: "/skills", label: "Skills", roles: everyone, fixtureSurface: "scope-aware capability explorer" },
  { href: "/clients", label: "Clients", roles: everyone, fixtureSurface: "shared scoped client records" },
  { href: "/projects", label: "Projects", roles: everyone, fixtureSurface: "shared scoped project records" },
  { href: "/locations", label: "Locations", roles: everyone, fixtureSurface: "shared scoped operational locations" },
  ...
  { href: "/analytics", label: "Analytics dashboard", roles: managers, fixtureSurface: "scoped historical analytics" },
  { href: "/reports", label: "Reports", roles: managers, fixtureSurface: "scoped report tables and trends" },
