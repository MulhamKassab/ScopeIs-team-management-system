...
export const auditActions: Record<string, { label: string; fields: readonly string[] }> = {
  ...
  "auth.account.created": { label: "Account created", fields: ["role", "signInEnabled", "mustChangePassword"] },
  "auth.credentials.enabled": { label: "Sign-in enabled for existing record", fields: ["signInEnabled", "mustChangePassword"] },
  "auth.password.reset": { label: "Password reset", fields: ["sessionsRevoked", "mustChangePassword", "credentialVersion", "signInEnabled"] },
  "auth.password.changed": { label: "Password changed", fields: ["mustChangePassword", "credentialVersion"] },
