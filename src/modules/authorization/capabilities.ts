...
const roleCapabilities: Record<SystemRole, readonly Capability[]> = {
  ...
  ADMIN: ["dashboard", "employees", "skills", "clients", "projects", "locations", "schedule", "map", "leave", "coverage", "replacements", "notifications", "profile"].map((module) => `module:${module}:view` as Capability).concat("foundation:scope_probe:view"),
