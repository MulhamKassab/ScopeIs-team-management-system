...
Production uses only the existing Vercel Production configuration. Mock authentication remains fail-closed. Neon is on the Free plan: before real employee, HR, certification, portfolio, or operational data is entered, backup and recovery policy must be explicitly established and verified. Production is never a test or seed target. Phase 3–9 remain deferred.
