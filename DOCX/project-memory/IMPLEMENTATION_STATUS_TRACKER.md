...
- **Most recent trustworthy evidence:** [Credential auth R1] (implementation pushed; Production cutover blocked on the pepper secret and verified database target), [Credential auth decisions], [Pre-Phase-12 hardening], [Phase 11 report]
